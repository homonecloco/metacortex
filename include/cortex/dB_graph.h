...
void db_graph_print_supernode_from_begining(char * filename, int max_length, boolean with_coverages, dBGraph * db_graph);

int db_graph_get_perfect_path_with_first_edge_multipath(dBNode * node, Orientation orientation, Nucleotide fst_nucleotide, void(*node_action)(dBNode * node), Path * path, dBGraph * db_graph);

void db_graph_path_calculate_coverage(dBNode * * path_nodes, double * avg_coverage, int * min_coverage, int * max_coverage, int length, boolean notHead);

int db_graph_db_node_prune_edges_with_single_coverage(dBNode * node, int coverage, void(*node_action)(dBNode * node), dBGraph * db_graph);
...
boolean db_graph_path_splits(dBNode * node, Orientation o, dBGraph * db_graph, int limit);
...
boolean db_graph_db_node_smooth_bubble(dBNode * node, Orientation orientation, int limit, int coverage_limit, void(*node_action)(dBNode * node), dBGraph * db_graph);

boolean db_graph_db_node_prune_low_coverage(dBNode * node, int coverage, void(*node_action)(dBNode * node), dBGraph * db_graph);
...
dBNode * db_graph_get_first_from_Y(dBNode * n, Orientation o, int limit, dBGraph * db_graph, boolean rev);

pathStep* db_graph_get_first_node_in_supernode_containing_given_node( pathStep* step, dBGraph* db_graph);
